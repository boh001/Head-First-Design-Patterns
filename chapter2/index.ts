...
class CurrentConditionsDisPlayWithPull implements ObserverWithPull, DisplayElement {
  private temperature: number
  private humidity: number
...
function main() {
  ...
  const currentConditionsDisPlayWithPull = new CurrentConditionsDisPlayWithPull(weatherDataWithPull)
